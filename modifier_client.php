...
while($dataVerif = $verifAdmin->fetch(PDO::FETCH_ASSOC))
{
    $varAdmin = $dataVerif ['EtatAdmin'];
}
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="POST" action="scripts/modifier_process2.php">
                    ...
                    <div class="wrap-input100 validate-input m-b-16" data-validate="Merci d'entrer votre N° de télépone">
						<input class="input100" type="text" name="Telephone" placeholder="Numero de téléphone">
						<span class="focus-input100"></span>
					</div>
					</br>
